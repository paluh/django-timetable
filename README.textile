...
Thanks to Patrys implementation of abstract models factory (abstract.py taken from here: http://gist.github.com/584106) you can subclass event and occurrences models as you want without using generic relations.
